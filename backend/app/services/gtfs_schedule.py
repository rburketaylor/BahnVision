...
class GTFSScheduleService:
    ...
    async def get_stop_departures(
        ...
        # Optimization: pre-calculate midnight for today to avoid repeated datetime.combine calls
...
def interval_to_datetime(
    ...
    Args:
        ...
        interval_value: The interval (timedelta or string) to add.
        base_datetime: Optional pre-calculated midnight datetime (UTC) for the service date.
                      If provided, avoids recalculating it via datetime.combine.
    """

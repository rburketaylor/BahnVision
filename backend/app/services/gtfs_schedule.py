...
class GTFSScheduleService:
    ...
    async def get_stop_departures(
        ...
        """
        # Pre-fetch relevant stops to avoid OR join in main query
        ...
        stop_names = {row.stop_id: row.stop_name for row in stop_result}

        if not stop_names and validate_existence:
        ...
        # s alias no longer needed for join
        ...
        query = (
            ...
            .where(
                st.stop_id.in_(stop_names.keys()),

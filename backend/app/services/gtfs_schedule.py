...
class GTFSScheduleService:
    ...
    async def get_stop_departures(
        ...
        departures = []
        # Pre-calculate midnight to avoid doing it for every row in interval_to_datetime
...
def interval_to_datetime(
    ...
    Args:
        ...
        base_datetime: Optional pre-calculated midnight datetime to avoid redundant calls.
            If None, it is calculated from service_date.
    """

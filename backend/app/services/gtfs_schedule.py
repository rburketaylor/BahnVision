...
class ScheduledDeparture:
    ...
    # Optimization: Using __slots__ reduces memory overhead per instance from ~344 bytes to ~112 bytes, significantly improving performance when caching thousands of schedule departures.
    __slots__ = [
        "departure_time",
        "trip_headsign",
        "route_short_name",

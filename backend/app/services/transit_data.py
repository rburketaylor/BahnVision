...
class TransitDataService:
    ...
    async def _apply_real_time_updates(
        ...
        try:
            ...
            # We can calculate trip_ids immediately as they come from scheduled departures
            ...
            # Optimization: Fetching updates and positions in parallel reduces latency
            trip_updates, vehicle_positions = await asyncio.gather(
                trip_updates_task, vehicle_positions_task
            )

            # Create lookup map for trip updates
            update_map = {}
            ...
            for departure in departures:
                # Apply trip updates (delays, cancellations)

...
class TestIntervalToDatetime:
    ...
    @pytest.fixture
    def service_midnight(self):
        return datetime(2025, 12, 8, 0, 0, 0, tzinfo=timezone.utc)

    def test_interval_to_datetime_with_timedelta(self, service_midnight):
    ...
    def test_interval_to_datetime_over_24h(self, service_midnight):
    ...
    def test_interval_to_datetime_string_format(self, service_midnight):
    ...
    def test_interval_to_datetime_none(self, service_midnight):
        """Test that None returns None."""
        result = interval_to_datetime(service_midnight, None)
        assert result is None

    def test_interval_to_datetime_invalid_format(self, service_midnight):
        ...
        expected = service_midnight
        assert result == expected

    def test_interval_to_datetime_string_with_seconds(self, service_midnight):
    ...
    def test_interval_to_datetime_unknown_type(self, service_midnight):
    ...
    def test_interval_to_datetime_value_error(self, service_midnight):

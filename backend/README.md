...
Valkey‑backed cache with cache‑aside reads, single‑flight stampede protection, and stale refresh to keep latency predictable during upstream issues. See technical details in `docs/tech-spec.md`.

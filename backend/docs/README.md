...
This directory centralises project documentation so engineering, product, and ops references stay aligned. Start with the canonical backend tech spec in `docs/tech-spec.md`.
...
- `archive/` – historical documents kept for context (e.g. the original AI-first design vision and legacy TODO lists). These are superseded by `docs/tech-spec.md`.

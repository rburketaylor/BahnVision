...
function createMockStop(
  overrides: Partial<TransitStop> & { id: string; name: string }
): TransitStop {
  return {
    latitude: 48.137,
    longitude: 11.575,
...
describe('recentSearches', () => {
  ...
  describe('addRecentSearch', () => {
    ...
    it('adds new search to localStorage', () => {
      ...
      expect(localStorageMock.setItem).toHaveBeenCalledWith(RECENT_SEARCHES_KEY, expect.any(String))
